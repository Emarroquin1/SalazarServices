 ...
 document.getElementById("a1").addEventListener('click',function(e){
    ...
    if(validador==1){
        ...
        document.getElementById('a1').style.color='#09ff8c';
    ...
    document.getElementById('a2').style.color='#09ff8c';
    ...
    document.getElementById('a3').style.color='#09ff8c';
    ...
    document.getElementById('a4').style.color='#09ff8c';
